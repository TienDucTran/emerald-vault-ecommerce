...
export function LowStockAlerts() {
  return (
    <div>
      ...
      <div className="divide-y divide-[#4D4635]/10">
        {lowStockItems.map((item, i) => {
          ...
          return (
            <div
              key={item.sku}
              className="flex items-center justify-between px-6 py-3 hover:bg-[rgba(56,52,43,0.1)] transition-colors"
            >
              <div className="flex items-center gap-3">
                ...
                />
                <div>
                  <p className="text-xs text-[#D0C5AF]">{item.name}</p>
              ...
              <div className="flex items-center gap-3">
                ...
                {/* Threshold */}
                <span className="text-[10px] text-[#D0C5AF]/30">/ {item.threshold}</span>
              </div>
            </div>
          );
        })}
      ...
      {/* Footer */}
      <div className="px-6 py-3 border-t border-[#4D4635]/30">
