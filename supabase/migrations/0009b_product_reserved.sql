-- ============================================================================
-- Migration 0009b: Add RESERVED status to product_status_enum
-- ----------------------------------------------------------------------------
...
--
-- File này thay thế migration cũ 0010_product_reserved.sql (đã xóa content
-- bên dưới vì duplicate numbering với 0010_storage_jewelry_images.sql gây
-- Supabase CLI chỉ chạy 1 trong 2 tùy sort order — đã được audit 2026-07-27).
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 3. confirm_payment RPC — RESERVED → SOLD_OUT: trạng thái cuối sau khi thanh toán xác nhận
