...
export default function SettingsPage() {
  return (
    <div className="space-y-8 animate-fade-in">
      {/* Header */}
      <div>
        <h1 className="font-heading text-2xl font-bold text-[#EAE1D4] tracking-tight">Settings</h1>
      ...
      >
        ...
        <div className="flex items-center justify-between">
          ...
          <button className="px-4 py-2 rounded-sm text-[10px] font-heading tracking-[0.1em] uppercase border border-gold/20 text-gold/70 hover:text-gold transition-colors">
            Test Connection
          </button>
        </div>
      ...
      {/* Save Button */}
      <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#4D4635]/30">
        <button className="px-6 py-2.5 rounded-sm text-xs font-heading tracking-[0.15em] uppercase font-bold bg-gold text-[#3C2F00] hover:bg-gold/90 transition-colors">
          Save Changes
        </button>
      </div>
    </div>
